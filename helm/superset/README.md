...
![Version: 0.15.6](https://img.shields.io/badge/Version-0.15.6-informational?style=flat-square)
...
| supersetMcp.enabled | bool | `false` | Enables the Superset MCP Server, exposed by default via the ingress /mcp subpath WARNING: this requires fastMCP to be installed, which can be done by installing `apache-superset[fastmcp]` |
...
| supersetMcp.livenessProbe.httpGet.httpHeaders[0].name | string | `"Accept"` |  |
| supersetMcp.livenessProbe.httpGet.httpHeaders[0].value | string | `"text/html"` |  |
| supersetMcp.livenessProbe.httpGet.path | string | `"/mcp"` |  |
| supersetMcp.livenessProbe.httpGet.port | int | `5008` |  |
...
| supersetMcp.readinessProbe.httpGet.httpHeaders[0].name | string | `"Accept"` |  |
| supersetMcp.readinessProbe.httpGet.httpHeaders[0].value | string | `"text/html"` |  |
| supersetMcp.readinessProbe.httpGet.path | string | `"/mcp"` |  |
| supersetMcp.readinessProbe.httpGet.port | int | `5008` |  |
...
| supersetMcp.startupProbe.httpGet.httpHeaders[0].name | string | `"Accept"` |  |
| supersetMcp.startupProbe.httpGet.httpHeaders[0].value | string | `"text/html"` |  |
| supersetMcp.startupProbe.httpGet.path | string | `"/mcp"` |  |
| supersetMcp.startupProbe.httpGet.port | int | `5008` |  |
