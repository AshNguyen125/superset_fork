...
| ('SUM(num)', 'boy')            |              47123 |
| ('SUM(num)', 'girl')           |             118065 |
| ('SUM(num)', 'Subvalue (Sum)') |             165188 |
| ('MAX(num)', 'boy')            |               1280 |
| ('MAX(num)', 'girl')           |               2588 |
| ('MAX(num)', 'Subvalue (Sum)') |               3868 |
| ('{_("Total")} (Sum)', '')            |             169056 |
    """.strip()
    )
...
| ('boy', 'SUM(num)')        |              47123 |
| ('boy', 'MAX(num)')        |               1280 |
| ('boy', 'Subvalue (Sum)')  |              48403 |
| ('girl', 'SUM(num)')       |             118065 |
| ('girl', 'MAX(num)')       |               2588 |
| ('girl', 'Subvalue (Sum)') |             120653 |
| ('{_("Total")} (Sum)', '')        |             169056 |
    """.strip()
    )
...
def test_pivot_df_single_row_null_mix_values_strings():
    """
    Pivot table when a single column and 2 metrics are selected.
    """
    df = pd.DataFrame.from_dict(
...
def test_pivot_df_single_row_null_mix_values_numbers():
    """
    Pivot table when a single column and 2 metrics are selected.
    """
    df = pd.DataFrame.from_dict(
...
| ('girl', 'Sophia') |                18859 |                 2588 |                 7181 |                 1187 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                            |   ('SUM(num)', 'CA') |   ('SUM(num)', 'FL') |   ('SUM(num)', 'Subvalue (Sum)') |   ('MAX(num)', 'CA') |   ('MAX(num)', 'FL') |   ('MAX(num)', 'Subvalue (Sum)') |   ('Total (Sum)', '') |
|:---------------------------|---------------------:|---------------------:|---------------------------------:|---------------------:|---------------------:|---------------------------------:|----------------------:|
| ('boy', 'Edward')          |                31290 |                 9395 |                            40685 |                 1280 |                  389 |                             1669 |                 42354 |
| ('boy', 'Tony')            |                 3765 |                 2673 |                             6438 |                  598 |                  247 |                              845 |                  7283 |
| ('boy', 'Subvalue (Sum)')  |                35055 |                12068 |                            47123 |                 1878 |                  636 |                             2514 |                 49637 |
...
| ('girl', 'Subvalue (Sum)') |                89837 |                28228 |                           118065 |                 6814 |                 2719 |                             9533 |                127598 |
...
| ('girl', 'Sophia', 'MAX(num)') |      2588 |      1187 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                            |   ('CA', 'SUM(num)') |   ('CA', 'MAX(num)') |   ('CA', 'Subvalue (Sum)') |   ('FL', 'SUM(num)') |   ('FL', 'MAX(num)') |   ('FL', 'Subvalue (Sum)') |   ('Total (Sum)', '') |
|:---------------------------|---------------------:|---------------------:|---------------------------:|---------------------:|---------------------:|---------------------------:|----------------------:|
| ('boy', 'Edward')          |                31290 |                 1280 |                      32570 |                 9395 |                  389 |                       9784 |                 42354 |
| ('boy', 'Tony')            |                 3765 |                  598 |                       4363 |                 2673 |                  247 |                       2920 |                  7283 |
| ('boy', 'Subvalue (Sum)')  |                35055 |                 1878 |                      36933 |                12068 |                  636 |                      12704 |                 49637 |
| ('girl', 'Amy')            |                45426 |                 2227 |                      47653 |                14740 |                  854 |                      15594 |                 63247 |
| ('girl', 'Cindy')          |                14149 |                  842 |                      14991 |                 1218 |                  217 |                       1435 |                 16426 |
| ('girl', 'Dawn')           |                11403 |                 1157 |                      12560 |                 5089 |                  461 |                       5550 |                 18110 |
| ('girl', 'Sophia')         |                18859 |                 2588 |                      21447 |                 7181 |                 1187 |                       8368 |                 29815 |
| ('girl', 'Subvalue (Sum)') |                89837 |                 6814 |                      96651 |                28228 |                 2719 |                      30947 |                127598 |
| ('Total (Sum)', '')        |               124892 |                 8692 |                     133584 |                40296 |                 3355 |                      43651 |                177235 |
    """.strip()  # noqa: E501
    )
...
| ('boy', 'Subvalue (Sum as Fraction of Columns)')  |            0.280683  |            0.299484  |            0.216061  |            0.189568  |
...
| ('girl', 'Subvalue (Sum as Fraction of Columns)') |            0.719317  |            0.700516  |            0.783939  |            0.810432  |
...
| ('Total (Sum)',) |                 12068 |                   636 |                  28228 |                   2719 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                  |   ('SUM(num)', 'boy') |   ('SUM(num)', 'girl') |   ('SUM(num)', 'Subvalue (Sum)') |   ('MAX(num)', 'boy') |   ('MAX(num)', 'girl') |   ('MAX(num)', 'Subvalue (Sum)') |   ('Total (Sum)', '') |
|:-----------------|----------------------:|-----------------------:|---------------------------:|----------------------:|-----------------------:|---------------------------:|----------------------:|
...
| ('boy', 'Subvalue (Sum)')  |     36933 |              12704 |
| ('girl', 'SUM(num)')       |     89837 |              28228 |
| ('girl', 'MAX(num)')       |      6814 |               2719 |
| ('girl', 'Subvalue (Sum)') |     96651 |              30947 |
...
| ('boy', 'Subvalue (Sum as Fraction of Columns)')  |           0.285269  |           0.208683  |
| ('girl', 'Amy')                                   |           0.364227  |           0.255748  |
| ('girl', 'Cindy')                                 |           0.0930273 |           0.0879057 |
| ('girl', 'Dawn')                                  |           0.0998378 |           0.134307  |
| ('girl', 'Sophia')                                |           0.157639  |           0.313356  |
| ('girl', 'Subvalue (Sum as Fraction of Columns)') |           0.714731  |           0.791317  |
...
def test_pivot_multi_level_index():
    ...
    assert (
        pivoted_sorted.to_markdown()
        == """
|                                         |   ('SUM(value)',) |   ('AVG(value)',) |   ('COUNT(value)',) |
|:----------------------------------------|------------------:|------------------:|--------------------:|
| ('Region1', 'State1', 'City1')          |                10 |                 5 |                   0 |
| ('Region1', 'State1', 'City2')          |                20 |                10 |                   0 |
| ('Region1', 'State1', 'Subvalue (Sum)') |                30 |                15 |                   0 |
| ('Region1', 'State2', 'City3')          |                10 |                 5 |                   0 |
| ('Region1', 'State2', 'City4')          |                20 |                10 |                   0 |
| ('Region1', 'State2', 'Subvalue (Sum)') |                30 |                15 |                   0 |
| ('Region1', 'Subvalue (Sum)', '')       |                60 |                30 |                   0 |
| ('Region2', 'State3', 'City5')          |                30 |                15 |                   0 |
| ('Region2', 'State3', 'City6')          |                60 |                30 |                   0 |
| ('Region2', 'State3', 'Subvalue (Sum)') |                90 |                45 |                   0 |
| ('Region2', 'State4', 'City7')          |                10 |                 5 |                   0 |
| ('Region2', 'State4', 'City8')          |                50 |                25 |                   0 |
| ('Region2', 'State4', 'Subvalue (Sum)') |                60 |                30 |                   0 |
| ('Region2', 'Subvalue (Sum)', '')       |               150 |                75 |                   0 |
| ('Total (Sum)', '', '')                 |               210 |               105 |                   0 |
    """.strip()
    )
