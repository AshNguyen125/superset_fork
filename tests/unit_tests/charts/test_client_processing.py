...
| ('SUM(num)', 'boy')      |                nan |
| ('SUM(num)', 'girl')     |             118065 |
| ('SUM(num)', 'Subvalue') |             118065 |
| ('MAX(num)', 'boy')      |                nan |
| ('MAX(num)', 'girl')     |               2588 |
| ('MAX(num)', 'Subvalue') |               2588 |
| ('{_("Total")} (Sum)', '')      |             120653 |
    """.strip()
    )
...
| ('girl', 'Sophia') |                18859 |                 2588 |                 7181 |                 1187 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                      |   ('SUM(num)', 'CA') |   ('SUM(num)', 'FL') |   ('SUM(num)', 'Subvalue') |   ('MAX(num)', 'CA') |   ('MAX(num)', 'FL') |   ('MAX(num)', 'Subvalue') |   ('Total (Sum)', '') |
|:---------------------|---------------------:|---------------------:|---------------------------:|---------------------:|---------------------:|---------------------------:|----------------------:|
| ('boy', 'Edward')    |                31290 |                 9395 |                      40685 |                 1280 |                  389 |                       1669 |                 42354 |
| ('boy', 'Tony')      |                 3765 |                 2673 |                       6438 |                  598 |                  247 |                        845 |                  7283 |
| ('boy', 'Subvalue')  |                35055 |                12068 |                      47123 |                 1878 |                  636 |                       2514 |                 49637 |
...
| ('girl', 'Subvalue') |                89837 |                28228 |                     118065 |                 6814 |                 2719 |                       9533 |                127598 |
...
| ('boy', 'Subvalue')                        |            0.280683  |            0.299484  |            0.216061  |            0.189568  |
...
| ('girl', 'Subvalue')                       |            0.719317  |            0.700516  |            0.783939  |            0.810432  |
...
| ('Total (Sum)',) |                 12068 |                   636 |                  28228 |                   2719 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                  |   ('SUM(num)', 'boy') |   ('SUM(num)', 'girl') |   ('SUM(num)', 'Subvalue') |   ('MAX(num)', 'boy') |   ('MAX(num)', 'girl') |   ('MAX(num)', 'Subvalue') |   ('Total (Sum)', '') |
|:-----------------|----------------------:|-----------------------:|---------------------------:|----------------------:|-----------------------:|---------------------------:|----------------------:|
...
| ('boy', 'Subvalue')  |     36933 |              12704 |
| ('girl', 'SUM(num)') |     89837 |              28228 |
| ('girl', 'MAX(num)') |      6814 |               2719 |
| ('girl', 'Subvalue') |     96651 |              30947 |
...
| ('girl', 'Sophia') |               26040 |                3775 |
 """.strip()
    ...
    assert (
        pivoted.to_markdown()
        == """
|                      |   ('SUM(num)', nan) |   ('SUM(num)', 'Subvalue') |   ('MAX(num)', nan) |   ('MAX(num)', 'Subvalue') |   ('Total (Sum)', '') |
|:---------------------|--------------------:|---------------------------:|--------------------:|---------------------------:|----------------------:|
| ('boy', 'Edward')    |               40685 |                      40685 |                1669 |                       1669 |                 42354 |
| ('boy', 'Tony')      |                6438 |                       6438 |                 845 |                        845 |                  7283 |
| ('boy', 'Subvalue')  |               47123 |                      47123 |                2514 |                       2514 |                 49637 |
...
| ('girl', 'Subvalue') |              118065 |                     118065 |                9533 |                       9533 |                127598 |
...
|                     |   ('boy', 'Edward') |   ('boy', 'Tony') |   ('boy', 'Subvalue') |   ('girl', 'Amy') |   ('girl', 'Cindy') |   ('girl', 'Dawn') |   ('girl', 'Sophia') |   ('girl', 'Subvalue') |   ('Total (Sum)', '') |
|:--------------------|--------------------:|------------------:|----------------------:|------------------:|--------------------:|-------------------:|---------------------:|-----------------------:|----------------------:|
| (nan, 'SUM(num)')   |               40685 |              6438 |                 47123 |             60166 |               15367 |              16492 |                26040 |                 118065 |                165188 |
| (nan, 'MAX(num)')   |                1669 |               845 |                  2514 |              3081 |                1059 |               1618 |                 3775 |                   9533 |                 12047 |
| (nan, 'Subvalue')   |               42354 |              7283 |                 49637 |             63247 |               16426 |              18110 |                29815 |                 127598 |                177235 |
| ('Total (Sum)', '') |               42354 |              7283 |                 49637 |             63247 |               16426 |              18110 |                29815 |                 127598 |                177235 |
    """.strip()  # noqa: E501
    )
...
| ('Region1', 'State1', 'Subvalue') |             30 |             15 |              0 |
| ('Region1', 'State2', 'City3')    |             30 |             15 |            nan |
| ('Region1', 'State2', 'Subvalue') |             30 |             15 |              0 |
| ('Region1', 'Subvalue', '')       |             60 |             30 |              0 |
| ('Region2', 'State3', 'City4')    |             40 |             20 |            nan |
| ('Region2', 'State3', 'City5')    |             50 |             25 |            nan |
| ('Region2', 'State3', 'Subvalue') |             90 |             45 |              0 |
| ('Region2', 'State4', 'City6')    |             60 |             30 |            nan |
| ('Region2', 'State4', 'Subvalue') |             60 |             30 |              0 |
| ('Region2', 'Subvalue', '')       |            150 |             75 |              0 |
| ('Total (Sum)', '', '')           |            210 |            105 |              0 |
    """.strip()
    )
